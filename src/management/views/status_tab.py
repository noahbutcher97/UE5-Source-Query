...
class StatusTab:
    ...
    def _build_deployed_status(self, parent_frame):
        ...
        try:
            from src.utils.engine_helper import find_uproject_in_directory, get_engine_version_from_uproject, detect_engine_from_vector_store
    ...
    def _build_dev_repo_status(self, parent_frame):
        ...
        try:
            from src.utils.deployment_detector import DeploymentRegistry
